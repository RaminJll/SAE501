...
router.get("/allMatiereGrasse", async (req, res, next) => {
  try {
    ...
    const urls = [
      { 
        ...
        params: { categories_tags_fr: 'amandes', fields: fields }
      },
      { 
        url: "https://world.openfoodfacts.org/api/v2/search", 
        params: { categories_tags_fr: 'pistache', fields: fields }
      },
      { 
        url: "https://world.openfoodfacts.org/api/v2/search", 
        params: { categories_tags_fr: 'noix', fields: fields }
      },
      { 
        url: "https://world.openfoodfacts.org/api/v2/search", 
        params: { categories_tags_fr: 'noisette', fields: fields }
      }
    ];
